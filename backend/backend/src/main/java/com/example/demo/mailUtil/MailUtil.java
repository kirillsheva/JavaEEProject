...
public class MailUtil {
	...
	public static void sendEmail(String recepient, String username, String userpassword) throws Exception {
		...
		String emailAccount = "vampshopingodwetrust@gmail.com";
		String password = "_v_a_m_p_1007";
	...
	private static Message prepareMessage(Session session, String email, String recepient, String username, String password) {
		try {
			...
			message.setText(
					"You are now registered as a store manager for VAMP online fashion store.\n\n"
					+"Username: "+username
					+"\n"+
					"Password: "+password);
			return message;
